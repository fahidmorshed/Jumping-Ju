...
/**
 *This object is for individual object's animation. Also determines collition with another
 *of this object. Every object contains a full animation for that object.
 */
public class Sprite extends Animatible {
	...
	//Needs to be overriden. As not all the Animating object need to respond to KeyEvents.
